...
{
    public partial class BookReserveStudent : Form
    {
        ...
        public BookReserveStudent(string username, string status, string bookStatus)
        {
            InitializeComponent();
        ...
        private void BookReserveStudent_Load(object sender, EventArgs e)
        {
            try
            {
                connection.Open();
                ...
                DGStudentReserve.DataSource = dataTable;
        ...
        public void SearchData(string keyword)
        {
            try
            {
                ...
                string selectQuery1 = $"SELECT * FROM StudentTableReserved WHERE StudentName LIKE '%{keyword}%'";
                dataAdapter.SelectCommand = new SqlCommand(selectQuery1, connection);
        ...
        {
            SearchData(txtSearchStudentReserved.Text);
        }
    }
}
